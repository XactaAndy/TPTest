    ...
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                IDataView trainingDataView = mlContext.Data.LoadFromTextFile(Server.MapPath("~/") + "//Files//training.csv", mlCols.ToArray(), ',', true, true, true, false);
                IDataView testingDataView = mlContext.Data.LoadFromTextFile(Server.MapPath("~/") + "//Files//testing.csv", mlCols.ToArray(), ',', true, true, true, false);
                ...
                mlContext.Model.Save(trainedModel, trainingDataView.Schema, "C://Temp//Bizmuth//Model.zip");
            }
        }
    }
}